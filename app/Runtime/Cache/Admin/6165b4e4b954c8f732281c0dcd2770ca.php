...
<div id="main">
    <div id="main_page_content">
        <div id="main_title"><h2>管理页面</h2></div>
        <div id="main_body">
            <div id="article_manage_table">
                <table id="article_manage" class="page" cellpadding="0" cellspacing="0">
                    <thead>
                    <tr>
                        <th class="articleTable_id">页面id</th>
                    ...
                    <?php if(is_array($page)): $i = 0; $__LIST__ = $page;if( count($__LIST__)==0 ) : echo "没有数据" ;else: foreach($__LIST__ as $key=>$var): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td class="articleTable_preview"><a href="/whugu/Admin/Page/preview/<?php echo ($var["id"]); ?>" target="_blank">预览</a>
                            <td class="articleTable_verify"><a class="verify" val="/whugu/Admin/Page/verify/<?php echo ($var["id"]); ?>">审核</a>
                            <td class="articleTable_update"><a href="/whugu/Admin/Page/update/<?php echo ($var["id"]); ?>" target="_blank">修改</a></td>
